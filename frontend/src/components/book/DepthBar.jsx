export default function DepthBar({ side, price, quantity, maxQuantity }) {
  ...
  return (
    <div className="relative overflow-hidden px-3 py-1.5 transition-colors hover:bg-slate-100">
      <div
      ...
      <div className="relative z-10 flex items-center justify-end gap-4">
        ...
        <span className="w-20 text-right font-mono text-sm text-slate-500">
          x{quantity}
        </span>
      </div>
    </div>
